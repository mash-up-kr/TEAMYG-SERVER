 ...
 * `RotateParfaitCanvasesUseCase`/`ForceRotateParfaitCanvasesUseCase` 빈 부재로 인한
...
class TestRotateParfaitCanvasesUseCaseConfig {
    ...
    @Bean
    fun forceRotateParfaitCanvasesUseCase(): ForceRotateParfaitCanvasesUseCase =
        object : ForceRotateParfaitCanvasesUseCase {
